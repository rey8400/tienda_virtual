...
<html lang="es">
  <head>
    ...
    <meta name="author" content="KAIFASTORE">
    <meta name="theme-color" content="#009688">
    <link rel="shortcut icon" href="<?= media();?>/images/favicon.ico">
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="<?= media();?>/css/main.css">
    <link rel="stylesheet" type="text/css" href="<?= media();?>/css/style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo media(); ?>/css/login.css">
  ...
  <body id="section">
    ...
    <div class="logo">
        <h1 class="gradiente"><img class="content"src="https://www.kayfastore.com/wp-content/uploads/kayfastore.png"></h1>
       <!-- <h1>Kayfa Store</h1>-->
      </div>
      <div class="login-box">
        <div id="divLoading" >
