					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-12">
								<input id="txtDirecciona" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Dirección de envío">
							</div>
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudada" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Ciudad / Departamento">
							</div>
						</div>
					
					<?php } else { ?>
				
						<h4 class="mtext-109 cl22 p-b-30">
							Tiene que Inciar Sesion o Registrarse para Realizar un Pedido
						</h4>
						<button type="button" class="btn btn-primary" onclick="openModal2();">Iniciar Sesion / Registrarse</button>
		...
		<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
			<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
				...
				<div class="flex-w flex-t bor12 p-b-13">
					<div class="size-208">
						<span class="stext-110 cl22">
							Subtotal:
						</span>
					</div>

					<div class="size-209">
						<span id="subTotalCompra" class="mtext-110 cl22">
				...
				<div class="flex-w flex-t p-t-27 p-b-33">
					<div class="size-208">
						<span class="mtext-101 cl22">
							Total:
						</span>
					</div>

					<div class="size-209 p-t-1">
						<span id="totalCompra" class="mtext-110 cl22">
				...
				?>
					...
					<div id="divMetodoPago">
						...
						<div class="divmetodpago">
							<div>
								<label for="paypal" class="notblock">
							...
							<div>
								<label for="contraentrega">
									<input type="radio" id="contraentrega" class="methodpago" checked="" name="payment-method" value="CT">
									<span>Contra Entrega</span>
								</label>
							</div>
							<div id="divtipopago" class="notbloc">
